...
function CartItemRow({
  ...
  return (
    <div className="flex items-center gap-4 p-4 bg-white rounded-lg border border-gray-100 hover:border-gray-200 transition-colors">
      {/* 选择框 */}
    ...
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      {items.length === 0 ? (
        ...
        <div className="space-y-6">
          {/* 商品列表头部 */}
          <div className="flex items-center gap-4 px-4 py-3 bg-gray-50 rounded-lg text-sm text-gray-600">
            <label className="flex items-center cursor-pointer">
              <input
                type="checkbox"
          ...
          {/* 结算栏 */}
          <div className="sticky bottom-0 left-0 right-0 bg-white border-t border-gray-100 py-4 -mx-4 px-4">
